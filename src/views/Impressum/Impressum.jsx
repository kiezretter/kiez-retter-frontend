        ...
        return (
            <>
                ...
                <Container maxWidth="md" className="kr-impressum">
                    ...
                    <Typography variant="h4" component="h3">Diensteanbieter</Typography>
                    <Typography>
                    ...
                    <Typography variant="h4" component="h3">Kontaktmöglichkeiten</Typography>
                    <Typography>
                    ...
                    <Typography variant="h4" component="h3">Vertretungsberechtigte</Typography>
                    <Typography>
                    ...
                    <Typography variant="h4" component="h3">Social Media und andere Onlinepräsenzen</Typography>
                    <Typography>
                    ...
                    <Typography variant="h4" component="h3">Bildnachweise</Typography>
                    <Typography>    
